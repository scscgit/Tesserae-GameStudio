...
/**
 * Uses some PI calculations, just like Ellipse. Could even inherit most of the stuff from Ellipse.
 * <p/>
 * Created by Steve on 23.2.2016.
 */
public class Ring extends FieldTemplate
{
	...
	public Ring(int rows, int columns)
	{
		super(rows, columns);
	...
	public boolean usingTile(int row, int column)
	{
		...
		return shapePosition < 1 && shapePosition > 0.12;
	}
