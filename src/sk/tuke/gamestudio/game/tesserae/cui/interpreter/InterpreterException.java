...
/**
 * Exceptions that arise from Interpreter usage.
 * They are mostly meant to be safely returned to the user in the form of String.
 * <p/>
 * InterpreterException is not a type of TesseraeRuntimeException!
 * <p/>
