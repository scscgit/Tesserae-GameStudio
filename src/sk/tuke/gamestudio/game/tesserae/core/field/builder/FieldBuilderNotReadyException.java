...
/**
 * Field Builder complains loudly.
 * <p/>
 * Created by Steve on 29.2.2016.
 */
public class FieldBuilderNotReadyException extends TesseraeRuntimeException
{
	/**
	 ...
	 */
	public FieldBuilderNotReadyException()
	{
		super("Field Builder is not ready to build a Field.");
	}
	/**
	 ...
	 */
	public FieldBuilderNotReadyException(String message)
	{
		super(message);
	}
}
