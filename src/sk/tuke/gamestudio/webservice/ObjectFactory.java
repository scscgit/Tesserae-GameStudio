...
public class ObjectFactory
{
	...
	private final static QName _ScoreException_QNAME = new QName("http://webservice.gamestudio.tuke.sk/",
	                                                             "ScoreException");
	private final static QName _GetBestScoresForGame_QNAME = new QName("http://webservice.gamestudio.tuke.sk/",
	                                                                   "getBestScoresForGame");
	private final static QName _AddScore_QNAME = new QName("http://webservice.gamestudio.tuke.sk/", "addScore");
	private final static QName _GetBestScoresForGameResponse_QNAME = new QName("http://webservice.gamestudio.tuke.sk/",
	                                                                           "getBestScoresForGameResponse");
	private final static QName _AddScoreResponse_QNAME = new QName("http://webservice.gamestudio.tuke.sk/",
	                                                               "addScoreResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
	 * sk.tuke.gamestudio.webservice
	 */
	...
	{
		return new JAXBElement<GetBestScoresForGame>(_GetBestScoresForGame_QNAME, GetBestScoresForGame.class, null,
		                                             value);
	}
	...
	public JAXBElement<GetBestScoresForGameResponse> createGetBestScoresForGameResponse(
		GetBestScoresForGameResponse value)
	{
		return new JAXBElement<GetBestScoresForGameResponse>(_GetBestScoresForGameResponse_QNAME,
		                                                     GetBestScoresForGameResponse.class, null, value);
	}
