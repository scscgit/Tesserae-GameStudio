 ...
 * generated in the sk.tuke.gamestudio.webservice.score package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddScoreResponse_QNAME = new QName("http://score.webservice.gamestudio.tuke.sk/", "addScoreResponse");
    private final static QName _AddScore_QNAME = new QName("http://score.webservice.gamestudio.tuke.sk/", "addScore");
    private final static QName _GetBestScoresForGameResponse_QNAME = new QName("http://score.webservice.gamestudio.tuke.sk/", "getBestScoresForGameResponse");
    private final static QName _GetBestScoresForGame_QNAME = new QName("http://score.webservice.gamestudio.tuke.sk/", "getBestScoresForGame");
    private final static QName _ScoreException_QNAME = new QName("http://score.webservice.gamestudio.tuke.sk/", "ScoreException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sk.tuke.gamestudio.webservice.score
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://score.webservice.gamestudio.tuke.sk/", name = "addScoreResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://score.webservice.gamestudio.tuke.sk/", name = "addScore")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://score.webservice.gamestudio.tuke.sk/", name = "getBestScoresForGameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://score.webservice.gamestudio.tuke.sk/", name = "getBestScoresForGame")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://score.webservice.gamestudio.tuke.sk/", name = "ScoreException")
